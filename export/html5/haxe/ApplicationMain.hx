...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Game_2024", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Game_2024", null, 960, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1629";
		app.meta["company"] = "Darksider";
		app.meta["file"] = "Game_2024";
		app.meta["name"] = "Game 2024";
